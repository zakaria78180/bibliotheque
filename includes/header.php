<?php
// Charger l'authentification pour que la navbar reflète l'état de connexion sur toutes les pages
    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <ul class="navbar-nav">
                ...
                <li><a href="avis.php" <?php echo basename($_SERVER['PHP_SELF']) == 'avis.php' ? 'class="active"' : ''; ?>>Avis</a></li>
                ...
                <?php if (function_exists('estConnecte') && estConnecte()): ?>
                    <li><a href="mes_avis.php" <?php echo basename($_SERVER['PHP_SELF']) == 'mes_avis.php' ? 'class="active"' : ''; ?>>Mes avis</a></li>
                    <li class="nav-dropdown">
                        <a href="#" class="dropdown-toggle"><?php echo htmlspecialchars(utilisateurConnecteNom()); ?></a>
                        <ul class="dropdown-menu">
                ...
                <?php else: ?>
                    <li><a href="connexion.php" <?php echo basename($_SERVER['PHP_SELF']) == 'connexion.php' ? 'class="active"' : ''; ?>>Connexion</a></li>
                <?php endif; ?>
            </ul>
        </div>
    </nav>
